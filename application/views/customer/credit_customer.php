        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    if($this->permission1->method('paid_customer','read')->access()) { ?>
                        <a   style="background-color:#38469f;color:white;"  href="<?php echo base_url('Ccustomer/paid_customer')?>" class="btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('paid_customer')?> </a>
                    <?php } ?>
                    <!-- </div> -->
                    <!-- <div class="col-sm-2"> -->
      ...
      <th class="ID" data-resizable-column-id="1"    style="width: 80px; height: 40.0114px;" >ID</th>
        ...
        <th class="Email" data-resizable-column-id="6" style="width: 190.011px; height: 44.0114px;">Email</th>
           <th class="Phone" data-resizable-column-id="7"    style="width: 198.011px;"       >Phone</th>
            <th class="Balance" data-resizable-column-id="8"    style="width: 198.011px;"       >Due Amount</th>
...
<td class="Phone"><?php   echo $arr['phone'];  ?></td>
  <td class="credit_limit"><?php   echo $currency." ".$arr['due'];  ?></td>
...
?>
 ...
 <div id="myModal_colSwitch"  class="modal_colSwitch">
    ...
    <input type="checkbox"  data-control-column="8" checked = "checked" class="opt due amount" value="Due Amount"/>Due Amount<br>
