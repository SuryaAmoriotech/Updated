...
<div class="form-group row" style="float:left;">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-Customer" style="color:white;background-color:#38469f;" class="btn btn-success btn-large" name="add-Customer" value="<?php echo display('save') ?>" tabindex="5"/>
                            </div>
                        </div>
</div>
