...
if($a==$m){
 ...
 <i id="buddle_1" class="btn-danger removebundle fa fa-minus"  aria-hidden="true"  style="font-size:24px;" onclick="removebundle(); "></i>    
        ...
        <td class="cus" name="cus" style="width: 40px;"></td>  <td>
                           ...
                           <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text"  id="details" name="ac_details" class=" form-control"   rows="4" cols="50"  value="<?php echo $purchase_info[0]['ac_details'];  ?>"  style="width: inherit;" placeholder='Account Details/Additional Information' />
                                                <br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                             <input type="text" value="<?php echo $remarks;  ?>" id="remarks" name="remark"   rows="4" cols="50"  class="form-control" style="width: inherit;" placeholder='Remarks/Conditions'/>
