 ...
 <input list="magicHouses" name="prodt[]" id="prodt_1"  class="form-control product_name"  placeholder="Search Product" onfocus="this.value=''" onchange="this.blur();" />
  ...
  <span class="input-symbol-euro"><input type="text" id="cost_sq_ft_1"  name="cost_sq_ft[]" readonly  style="width:70px;" value="0.00"  class="cost_sq_ft form-control" ></span>
      ...
      <span class="input-symbol-euro">   <input type="text"  id="sales_slab_amt_1" name="sales_slab_amt[]"  style="width:70px;" value="0.00"  class="sales_slab_amt form-control"/></td> </span>
                                ...
                                <tfoot>
                                    <tr>
                                   <td style="text-align:right;" colspan="8"><b><?php echo display('Overall Gross Sq.Ft') ?> </b></td>
                                        <td >
