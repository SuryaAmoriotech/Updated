...
#download_select:focus option:first-of-type , #print_select:focus option:first-of-type{
 ...
 <input list="magicHouses" name="prodt[]" id="prodt_1"  class="form-control product_name"  placeholder="Search Product" onfocus="this.value=''" onchange="this.blur();" />
 ...
 <select name="print_select" id="print_select" class="form-control" style="color:white;background-color: #38469f;width: auto;" >
                           ...
                           <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea rows="4" cols="50" id="details" name="ac_details" class=" form-control" placeholder='Account Details/Additional Information' id="ac_details" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea rows="4" cols="50" id="remarks" name="remark" class=" form-control"    >                       
