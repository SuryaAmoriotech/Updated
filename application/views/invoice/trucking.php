...
<div class="col-sm-6">
   <div class="form-group row">
        <label for="supplier_sss" class="col-sm-4 col-form-label">Delivery to
            <i class="text-danger">*</i>
        </label>
        <div class="col-sm-8">
...
<div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label">Delivery Time
                                        <i class="text-danger">*</i>
                                    </label>
                                    ...
                                    <label for="supplier_sss" class="col-sm-1 col-form-label">TO
                                    </label>
                                    <div class="col-sm-3">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label">Truck No
                                         <i class="text-danger">*</i>
                                    </label>
                                     <div class="col-sm-8">
...
<input class=" form-control" type="file"  name="attachement" id="attachement" />
     ...
     <div class="col-sm-4">
          <a href="#" class="btn" style="color:white;background-color:#38469f;" data-dismiss="modal">Close</a>
     <input class="btn" type="submit" style="color:white;background-color:#38469f;"  name="submit_pay" id="submit_pay" value="submit"  required   />
</div>
     </div>
   </div>
   </form>
